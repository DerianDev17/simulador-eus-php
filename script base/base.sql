...
(1, 4, 'Al llegar al hotel nos han dado un mapa con los lugares de interés de la ciudad, y nos han dicho que 5 centímetros del mapa representan 600 metros de la realidad. Hoy queremos ir a un parque que se encuentra a 8 centímetros del hotel en el mapa. ¿A qué distancia del hotel se encuentra este parque?', '960 metros', '950 metros', '375 metros', '370 metros','A'),
(2, 4, 'Si por 12 camisetas pago 100/3 $, ¿cuánto pagaré por 57 de esas camisetas?', '158 dólares', '158.3 dólares', '159.3 dólares', '160 dólares','B'),
(3, 4, 'En 5 litros de agua de mar hay 130 g. de sal. ¿Cuántos litros hacen falta para 520 g. de sal?', '20 lt', '10 lt', '15 lt', '25 lt','C'),
(4, 4, 'Un auto gasta 5,(32) ̂litros de gasolina cada 100 kilómetros. ¿Cuántos kilómetros recorrerá con 28 litros?', '524 km', '526 km', '527 km', '528 km','B'),
(5, 4, 'Una rueda da 4.590 vueltas en 9 minutos. ¿Cuántas vueltas dará en 2 horas y media?', '76000 vueltas', '76400 vueltas', '76500 vueltas', '76200 vueltas','C'),
(6, 4, 'Un deportista recorre 4.500 m. en 10 minutos. ¿Cuántos km. recorrerá en media hora?', '13 km', '13.4 km', '13.5 km', '14 km','C'),
(7, 4, 'Un camión que carga 3.000 kg. da 15 viajes para transportar una carga. ¿Cuántos viajes dará otro camión que carga 9900 lb en transportar la misma carga?', '23 viajes', '22.5 viajes', '24 viajes', '22 viajes','A'),
(8, 4, 'Un obrero gana 350 dólares a la semana. ¿Cuánto gana en 45 días?', '2200 dólares', '2250 dólares', '2300 dólares', '2275 dólares','B'),
(9, 4, 'Por cada 24 kg. de aceitunas se obtienen 6 litros de aceite. ¿Cuántos litros se obtienen con 5 toneladas de aceitunas?', '1200 lt', '1300 lt', '1250 lt', '1350 lt','C'),
(10, 4, 'Por cada 24 kg. de aceitunas se obtienen 6 litros de aceite. ¿Cuántas toneladas de aceitunas se necesitan para llenar un depósito de 8.000 litros de aceite?', '30 toneladas', '32 toneladas', '31 toneladas', '29 toneladas','B'),
(11, 4, '5 CD´s de música cuestan 90 dólares. ¿Cuánto valen 3 cajas con 10 cd´s cada una?', '500 dólares', '520 dólares', '540 dólares', '560 dólares','C'),
(12, 4, 'Para abonar un terreno de 4.000 m2 necesitamos 50 kg. de abono que los tengo en la bodega. Si compro 20000 g. más, ¿Cuántos m2 puedo abonar?', '5000 m2', '5500 m2', '5600 m2', '5400 m2','C'),
(13, 4, 'Cada día leo durante 2 h y 10 minutos 25 páginas de un libro. Si el libro tiene 315 páginas, ¿Cuánto tiempo tardaré en leerlo?', '27h30min', '27h18min', '27h', '27h20min','B'),
(14, 4, 'Un auto tarda cuarto de hora en recorrer 10 kms. ¿Qué distancia recorrerá en 3 horas si va a la misma velocidad?', '120 km', '100 km', '110 km', '130 km','A'),
(15, 4, '1 kg de jamón cuesta 7,25 €, y se termina en 3 desayunos ¿Cuántos jamones debo comprar para que dure una semana?', '2.3 kg', '2.4 kg', '2.2 kg', '2 kg','A'),
(16, 4, 'Para alimentar a 30 perros se necesitan 45 kg. de comida. Si llegan 12 perros más, ¿Cuánta comida necesitamos?', '60 kg', '61 kg', '62 kg', '63 kg','D'),
(17, 4, 'Con 200 g. de harina se elaboran 6 barras de pan. ¿Cuántas barras se elaboran con 5 kg?', '100 barras', '120 barras', '150 barras', '170 barras','C'),
(18, 4, 'Este año hubo 42 días con lluvias, ¿Qué porcentaje del año significa eso?', '11.52 %', '11.51 %', '11.50 %', '11.53 %','B'),
(19, 4, 'Con cuarenta horas semanales de trabajo, un trabajador ganó $12000, ¿Cuánto ganará si la semana siguiente puede trabajar cincuenta horas?', '13500 dólares', '12500 dólares', '15000 dólares', '16000 dólares','C'),
(20, 4, 'Si una persona puede vivir en Nueva York durante 10 días con 650 dólares. ¿Cuántos días podrá costearse si solo tiene 500 dólares?', '7 días', '8 días', '9 días', '6 días','A');
